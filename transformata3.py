...
#przefiltrowany = ag.pasmowozaporowy(sygnal, czestProbkowania, 20, 30)
...
#plt.subplot(2, 1, 2)
#plt.plot(t, przefiltrowany, color='y')
#plt.ylim([-12, 12])
...
sygnal1 = A3*np.sin (2* np.pi*czestotliwosc3*t1)
trans = ag.FFT(sygnal1)

plt.subplot(2, 1, 1)
plt.plot(t1, sygnal1, color='y')
plt.ylim(-12, 12)
plt.xlabel("t[s]", size=18)
plt.ylabel("A[-]", size=18)
plt.subplot(2, 1, 2)
